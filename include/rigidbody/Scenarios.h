...
public:
    ...
    static void createCustomScenario2(RigidBodySystem &rigidBodySystem)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
    ...
    static void createCustomScenario3(RigidBodySystem &rigidBodySystem)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
    ...
    static void createCustomScenario4(RigidBodySystem &rigidBodySystem)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
    ...
    static void createCustomScenario5(RigidBodySystem &rigidBodySystem, float ball_x = 0.0f, float ball_y = 7.0f, float ball_z = 0.0f)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
    ...
    static void createCustomScenario6(RigidBodySystem &rigidBodySystem)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
    ...
    static void createCustomScenario7(RigidBodySystem &rigidBodySystem)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
    ...
    static void createCustomScenario8(RigidBodySystem &rigidBodySystem)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
    ...
    static void createCustomScenario9(RigidBodySystem &rigidBodySystem)
    {
        rigidBodySystem.clear();
        polyscope::removeAllStructures();
